...
namespace BusinessLayer.Managers
{
    ...
    {
        public async Task<List<SentimentPredictionDto>> GetEmotionalAnalysis(List<Comment> comments)
        {
            var context = new MLContext();
            var dataPath = "C:\\Users\\asame\\Desktop\\githubPersonal\\EcommerceScraping\\API\\analyse.csv";
