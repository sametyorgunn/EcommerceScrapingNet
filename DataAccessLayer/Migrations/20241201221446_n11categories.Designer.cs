...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20241201221446_n11categories")]
    partial class n11categories
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayer.Entity.N11Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("N11Categories");
                });

            modelBuilder.Entity("EntityLayer.Entity.N11SubCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("N11CategoryId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("N11CategoryId");

                    b.ToTable("N11SubCategories");
                });
            ...
            modelBuilder.Entity("EntityLayer.Entity.N11SubCategory", b =>
                {
                    b.HasOne("EntityLayer.Entity.N11Category", "N11Category")
                        .WithMany("N11SubCategories")
                        .HasForeignKey("N11CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("N11Category");
                });
